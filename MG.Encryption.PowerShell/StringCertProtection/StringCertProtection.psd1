...
FileList = 'MG.Dynamic.dll', 'MG.Encryption.dll', 'MG.Encryption.PowerShell.dll', 
               'StringCertCreation.psm1', 'StringCertProtection.psd1'
...
PrivateData = @{
    ...
    PSData = @{
        ...
        Tags = 'Encryption','Certificate','SHA256','Protect','String','Encrypt','Decrypt','Module','Cmdlet','Credential','SecureString','Plain','Text','Unprotect','New','Generate','Registry','PSPath'
        ...
        ReleaseNotes = 'Improve dynamic parameters.  Switch to use ASCII instead of UTF-8 encoding.'
